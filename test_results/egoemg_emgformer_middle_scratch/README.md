# egoemg_emgformer_middle_scratch

EMGFormer Middle (256d, 8 heads, 6 layers) on EgoEMG, no augmentation, from scratch.

- **Eval date**: 2026-05-05
- **Checkpoint**: `checkpoints/egoemg_emgformer_middle_scratch_mae0.2482_epoch108.ckpt`
- **Config**: `experiment=emgformer/egoemg_emgformer_middle_scratch`
