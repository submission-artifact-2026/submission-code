# egoemg_emgformer_large_scratch

EMGFormer Large (384d, 12 heads, 6 layers) on EgoEMG, no augmentation, from scratch.

- **Eval date**: 2026-05-05
- **Checkpoint**: `checkpoints/egoemg_emgformer_large_scratch_mae0.2479_epoch000.ckpt`
- **Config**: `experiment=emgformer/egoemg_emgformer_large_scratch`
