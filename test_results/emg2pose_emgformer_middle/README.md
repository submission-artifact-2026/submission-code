# emg2pose_emgformer_middle

EMG2Pose dataset, middle model (256d, 8 heads, 6 layers), aggressive augmentation.

- **Eval date**: 2026-05-03
- **Checkpoint**: `checkpoints/emg2pose_emgformer_middle_mae0.2269_epoch088.ckpt`
- **Config**: `experiment=emgformer/emg2pose_emgformer_middle`
