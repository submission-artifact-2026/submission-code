# egoemg_emgformer_small_scratch

EMGFormer Small (256d, 4 heads, 3 layers) on EgoEMG, no augmentation, from scratch.

- **Eval date**: 2026-05-05
- **Checkpoint**: `checkpoints/egoemg_emgformer_small_scratch_mae0.2562_epoch190.ckpt`
- **Config**: `experiment=emgformer/egoemg_emgformer_small_scratch`
