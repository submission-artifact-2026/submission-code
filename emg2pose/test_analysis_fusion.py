...
def _print_metrics_row(label: str, metrics: dict[str, float]) -> None:
    ...
    ftd = metrics.get("test_fingertip_distance", float("nan"))
    lmd = metrics.get("test_landmark_distance", float("nan"))
...
def main():
    ...
    channel_indices = cfg.get(
        "egoemg_emg2pose_channel_indices_1based", [11, 13, 1, 2, 3, 5, 6, 7]
    )
