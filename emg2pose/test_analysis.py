...
class EMG2PoseEvaluation:
    ...
    def get_module(self):
        ...
        if is_pretrain:
            ...
            module = EmgPredictionModule(
                ...
                gumbel_recon=self.config.get("gumbel_recon"),
    ...
    def _get_egoemg_dataloaders(self) -> list[DataLoader]:
        ...
        channel_indices = self.config.get("egoemg_emg2pose_channel_indices_1based",
                                          [11, 13, 1, 2, 3, 5, 6, 7])
        ...
        stride = int(dm_window) if dm_window else self.window_length
            ...
            for hand in ["left", "right"]:
                dataset = PretrainWrapperDataset(
                    base={
                        ...
                        'emg2pose_channel_indices_1based': channel_indices,
                        'channel_interpolate': channel_interpolate,
                        # Normalization handled by PretrainWrapperDataset (avoid double norm)
                    },
                    name='egoemg',
                    angle_dim=22,
